            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        ...
                        {{ $isEditing ? 'Edit Entri Jurnal' : 'Tambah Entri Jurnal Baru' }}
                    </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-light">
                                <h6 class="mb-0">
                                    <i class="ri-information-line"></i> Informasi Jurnal
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <label for="journal_no" class="form-label">
                                            Nomor Jurnal <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control" id="journal_no" wire:model="journal_no"
                                            readonly>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            id="journal_date" wire:model.change="journal_date" required>
                                        @error('journal_date')
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-select @error('id_period') is-invalid @enderror"
                                            id="id_period" wire:model="id_period" required disabled>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('reference') is-invalid @enderror"
                                            id="reference" wire:model="reference" placeholder="Nomor referensi">
                                        @error('reference')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                            id="description" wire:model="description" rows="2"
                        ...
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">
                                        <i class="ri-list-check-2"></i> Detail Entri Jurnal
                                    </h6>
