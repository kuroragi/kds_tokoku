        ...
        <div class="row g-3 align-items-end">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Cari nomor journal, referensi..."
    ...
    <div class="p-3 border-bottom">
        <div class="row align-items-center">
            ...
            <div class="col-md-9 text-end">
                <button class="btn btn-primary" wire:click="$dispatch('openJournalModal')">
                    <i class="ri-add-line"></i> Tambah Journal Entry
                </button>
            </div>
        </div>
    </div>
                    ...
                    <td class="text-center">
                        <div class="btn-group btn-group-sm" role="group">
                            ...
                            <button type="button" class="btn btn-outline-success"
                                onclick="confirmPostJournal('{{ $journal->journal_no }}', {{ $journal->id }})"
                            ...
                            <button type="button" class="btn btn-outline-danger"
                                onclick="confirmDeleteJournal('{{ $journal->journal_no }}', {{ $journal->id }})"
                                title="Hapus Journal">
                ...
                <tr>
                    <td colspan="7" class="text-center py-5">
                        <div class="d-flex flex-column align-items-center">
                            <i class="ri-book-line display-4 text-muted mb-3"></i>
                            <h5 class="text-muted mb-2">Tidak ada Journal Entry ditemukan</h5>
                            <p class="text-muted mb-0">
                                @if ($search || $filterStatus || $filterPeriod || $dateFrom || $dateTo)
                                Coba sesuaikan kriteria pencarian atau filter Anda
                                @else
                                Buat journal entry pertama Anda untuk memulai
                                @endif
                            </p>
                            @if (!$search && !$filterStatus && !$filterPeriod && !$dateFrom && !$dateTo)
                            <button class="btn btn-primary mt-3" wire:click="$dispatch('openJournalModal')">
                                <i class="ri-add-line"></i> Tambah Journal Entry
                            </button>
                            @endif
                        </div>
