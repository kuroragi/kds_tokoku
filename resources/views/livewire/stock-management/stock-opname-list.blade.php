<div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <button class="btn btn-primary btn-sm" wire:click="$dispatch('openStockOpnameModal')">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="8" class="text-center text-muted py-4">
                        <i class="ri-inbox-line fs-3 d-block mb-1"></i> Belum ada data stock opname.
                    </td>
                </tr>
                @endforelse
            </tbody>
