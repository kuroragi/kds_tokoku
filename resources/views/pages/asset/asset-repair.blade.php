        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Perbaikan Aset</h4>
                </div>
            </div>
        </div>
            ...
            <div class="card-header bg-white border-bottom">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0 small">Catat dan kelola perbaikan / pemeliharaan aset</p>
                    </div>
                </div>
            </div>

            @livewire('asset.asset-repair-list')
            @livewire('asset.asset-repair-form')
        </div>
    </div>
</div>
@endsection
