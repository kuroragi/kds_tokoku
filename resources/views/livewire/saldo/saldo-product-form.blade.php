            ...
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-primary text-white py-2">
                    <h6 class="modal-title">
                        ...
                        {{ $isEditing ? 'Edit Produk Saldo' : 'Tambah Produk Saldo' }}
                    </h6>
                ...
                <form wire:submit="save">
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Penyedia Saldo</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror"
                                    wire:model="code" placeholder="Contoh: PLS-50K">
                                @error('code') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Nama <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    wire:model="name" placeholder="Contoh: Pulsa 50.000">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                    wire:model="description" rows="2" placeholder="Deskripsi produk (opsional)"></textarea>
                                @error('description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Status</label>
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" wire:model="is_active" id="productIsActive">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Preview Margin</label>
                                <div class="mt-2">
                                    @php $margin = $sell_price - $buy_price; @endphp
                                    <span class="badge {{ $margin >= 0 ? 'bg-success' : 'bg-danger' }} fs-6">
