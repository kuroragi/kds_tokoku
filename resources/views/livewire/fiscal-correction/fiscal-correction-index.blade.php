            ...
            <div class="col-md-4">
                <div class="alert alert-info py-2 mb-0">
                    <small>
                        ...
                        <strong>Total Item:</strong> {{ $summary['count'] }}
                    </small>
                </div>
            </div>
            <div class="col-md-4">
                <div class="alert alert-success py-2 mb-0">
                    <small>
                        ...
                        <strong>Koreksi Positif:</strong> Rp {{ number_format($summary['total_positive'], 0, ',', '.') }}
                    </small>
                </div>
            </div>
            <div class="col-md-4">
                <div class="alert alert-danger py-2 mb-0">
                    <small>
                        ...
                        <strong>Koreksi Negatif:</strong> Rp {{ number_format($summary['total_negative'], 0, ',', '.') }}
                    </small>
                </div>
            </div>
        </div>
        ...
        <table class="table table-hover table-sm mb-0">
            ...
            <tfoot class="table-light">
                <tr class="fw-bold">
                    ...
                    <td class="text-end text-success">Rp {{ number_format($summary['total_positive'], 0, ',', '.') }}</td>
                    <td colspan="2"></td>
                </tr>
                <tr class="fw-bold">
                    <td colspan="4" class="text-end">Total Koreksi Negatif:</td>
                    <td class="text-end text-danger">Rp {{ number_format($summary['total_negative'], 0, ',', '.') }}</td>
                    <td colspan="2"></td>
                </tr>
                <tr class="fw-bold table-secondary">
                    <td colspan="4" class="text-end">Koreksi Neto:</td>
                    <td class="text-end">Rp {{ number_format($summary['total_positive'] - $summary['total_negative'], 0, ',', '.') }}</td>
                    <td colspan="2"></td>
                </tr>
            </tfoot>
            @endif
